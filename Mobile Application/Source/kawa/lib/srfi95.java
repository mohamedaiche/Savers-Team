  ...
  extends ModuleBody
{
  ...
  public static void $PcSortVector(Sequence paramSequence, Object paramObject1, Object paramObject2)
  {
    ...
    while (!lists.isNull(paramObject1)) {
      ...
      {
        throw new WrongType((ClassCastException)paramObject1, "vector-set!", 1, paramSequence);
      }
    }
  }
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\kawa\lib\srfi95.class
