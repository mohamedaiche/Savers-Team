  ...
  extends ModuleBody
{
  ...
  static
  {
    ...
    Object localObject3 = PairWithPosition.make(Lit23, Pair.make((SimpleSymbol)new SimpleSymbol("gnu.text.URLPath").readResolve(), Pair.make(Pair.make(Lit24, Pair.make((SimpleSymbol)new SimpleSymbol("valueOf").readResolve(), LList.Empty)), LList.Empty)), "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/misc_syntax.scm", 155655);
    ...
    ((PropertySet)localObject3).setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/misc_syntax.scm:29");
    ...
    ((PropertySet)localObject3).setProperty("source-location", "/Users/ewpatton/Programming/mit/ai2-kawa/kawa/lib/misc_syntax.scm:54");
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\kawa\lib\misc_syntax.class
