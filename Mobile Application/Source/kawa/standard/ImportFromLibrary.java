  ...
  extends Syntax
{
  ...
  static
  {
    ...
    String[] arrayOfString7 = { "11", "let-values", "" };
    String[] arrayOfString8 = { "13", "strings", "gnu.kawa.slib.srfi13" };
    String[] arrayOfString9 = { "14", "char-sets", MISSING };
    String[] arrayOfString10 = { "16", "case-lambda", "" };
    String[] arrayOfString11 = { "17", "generalized-set!", "" };
    String[] arrayOfString12 = { "18", "multithreading", MISSING };
    String[] arrayOfString13 = { "19", "time", MISSING };
    String[] arrayOfString14 = { "21", "real-time-multithreading", MISSING };
    String[] arrayOfString15 = { "23", "error", "" };
    String[] arrayOfString16 = { "25", "multi-dimensional-arrays", "" };
    String[] arrayOfString17 = { "26", "cut", "" };
    String[] arrayOfString18 = { "27", "random-bits", MISSING };
    String[] arrayOfString19 = { "28", "basic-format-strings", "" };
    String[] arrayOfString20 = { "29", "localization", MISSING };
    String[] arrayOfString21 = { "31", "rec", MISSING };
    String[] arrayOfString22 = { "38", "with-shared-structure", MISSING };
    String[] arrayOfString23 = { "41", "streams", MISSING };
    String[] arrayOfString24 = { "42", "eager-comprehensions", MISSING };
    String str = MISSING;
    ...
    String[] arrayOfString41 = { "71", "let", MISSING };
    String[] arrayOfString42 = { "74", "blobs", MISSING };
    String[] arrayOfString43 = { "78", "lightweight-testing", MISSING };
    String[] arrayOfString44 = { "86", "mu-and-nu", MISSING };
    String[] arrayOfString45 = { "87", "case", MISSING };
    String[] arrayOfString46 = { "95", "sorting-and-merging", "kawa.lib.srfi95" };
    SRFI97Map = new String[][] { arrayOfString1, arrayOfString2, arrayOfString3, arrayOfString4, arrayOfString5, arrayOfString6, arrayOfString7, arrayOfString8, arrayOfString9, arrayOfString10, arrayOfString11, arrayOfString12, arrayOfString13, arrayOfString14, arrayOfString15, arrayOfString16, arrayOfString17, arrayOfString18, arrayOfString19, arrayOfString20, arrayOfString21, arrayOfString22, { "39", "parameters", "" }, arrayOfString23, arrayOfString24, { "43", "vectors", str }, arrayOfString25, arrayOfString26, arrayOfString27, arrayOfString28, arrayOfString29, arrayOfString30, arrayOfString31, arrayOfString32, arrayOfString33, arrayOfString34, arrayOfString35, arrayOfString36, arrayOfString37, arrayOfString38, arrayOfString39, arrayOfString40, arrayOfString41, arrayOfString42, arrayOfString43, arrayOfString44, arrayOfString45, arrayOfString46 };
  }
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\kawa\standard\ImportFromLibrary.class
