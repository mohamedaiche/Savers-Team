  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public Spannable[] itemsToColoredText()
  {
    ...
    while (i <= k)
    {
      ...
      localSpannableString.setSpan(new AbsoluteSizeSpan(j), 0, localSpannableString.length(), 0);
  ...
  {
    paramAdapterView = (Spannable)paramAdapterView.getAdapter().getItem(paramInt);
    this.selection = paramAdapterView.toString();
    this.selectionIndex = (this.adapterCopy.getPosition(paramAdapterView) + 1);
    AfterPicking();
  }
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\com\google\appinventor\components\runtime\ListView.class
