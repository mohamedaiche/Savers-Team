    ...
    if (paramString1.equals("/_getversion")) {
      for (;;)
      {
        try
        {
          ...
          paramString1 = new NanoHTTPD.Response(this, "200 OK", "application/json", "{\"version\" : \"" + paramProperties2 + "\", \"fingerprint\" : \"" + Build.FINGERPRINT + "\"," + " \"installer\" : \"" + paramString2 + "\", \"package\" : \"" + paramProperties1 + "\", \"fqcn\" : true }");
        }
    ...
    if (paramString2.equals("PUT"))
    {
      ...
      if (paramString1 != null)
      {
        ...
        if (paramString1 != null)
        {
          ...
          paramString1 = paramProperties1.getParentFile();
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\com\google\appinventor\components\runtime\util\AppInvHTTPD.class
