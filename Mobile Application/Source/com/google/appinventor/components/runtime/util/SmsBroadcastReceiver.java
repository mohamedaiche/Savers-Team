  ...
  extends BroadcastReceiver
{
  ...
  private String getMessage(Intent paramIntent)
  {
    ...
    try
    {
      ...
      {
        localObject1 = localObject2;
        localObject3 = KitkatUtil.getMessagesFromIntent(paramIntent).iterator();
        ...
        for (;;)
        {
          ...
          localObject1 = paramIntent;
          localObject2 = (SmsMessage)((Iterator)localObject3).next();
          if (localObject2 != null)
          {
            localObject1 = paramIntent;
            paramIntent = ((SmsMessage)localObject2).getMessageBody();
          }
        }
      }
      localObject1 = localObject2;
      Object localObject3 = (Object[])paramIntent.getExtras().get("pdus");
      localObject1 = localObject2;
      ...
      for (;;)
      {
        ...
        paramIntent = SmsMessage.createFromPdu((byte[])localObject3[i]).getMessageBody();
        localObject1 = paramIntent;
        i += 1;
      }
    ...
    {
      Log.w("SmsBroadcastReceiver", "Unable to retrieve message body from SmsMessage", paramIntent);
      localObject2 = localObject1;
    }
  }
  ...
  private String getPhoneNumber(Intent paramIntent)
  {
    ...
    try
    {
      ...
      {
        localObject1 = localObject2;
        paramIntent = paramIntent.getExtras().getString("com.google.android.apps.googlevoice.PHONE_NUMBER");
        localObject1 = paramIntent;
        return PhoneNumberUtils.formatNumber(paramIntent);
      }
      localObject1 = localObject2;
      if (SdkLevel.getLevel() >= 19)
      {
        ...
        for (;;)
        {
          ...
          {
            localObject1 = paramIntent;
            paramIntent = ((SmsMessage)localObject2).getOriginatingAddress();
            localObject1 = paramIntent;
            if (SdkLevel.getLevel() >= 21)
            {
              localObject1 = paramIntent;
              paramIntent = LollipopUtil.formatNumber(paramIntent);
            }
            else
            {
              localObject1 = paramIntent;
              paramIntent = PhoneNumberUtils.formatNumber(paramIntent);
            }
          }
        }
      }
      ...
      for (;;)
      {
        ...
        paramIntent = SmsMessage.createFromPdu((byte[])localObject3[i]).getOriginatingAddress();
        localObject1 = paramIntent;
        paramIntent = PhoneNumberUtils.formatNumber(paramIntent);
        localObject1 = paramIntent;
        i += 1;
    ...
    {
      Log.w("SmsBroadcastReceiver", "Unable to retrieve originating address from SmsMessage", paramIntent);
      localObject2 = localObject1;
    }
  }
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\com\google\appinventor\components\runtime\util\SmsBroadcastReceiver.class
