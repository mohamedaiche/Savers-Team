  ...
  implements Component, MediaRecorder.OnErrorListener, MediaRecorder.OnInfoListener
{
  ...
  public void onInfo(MediaRecorder paramMediaRecorder, int paramInt1, int paramInt2)
  {
    ...
    default: 
      return;
    case 1: 
      this.form.dispatchErrorOccurredEvent(this, "recording", 801, new Object[0]);
    }
    for (;;)
    {
      try
      ...
      catch (IllegalStateException paramMediaRecorder)
      {
        Log.i("SoundRecorder", "SoundRecorder was not in a recording state.", paramMediaRecorder);
        this.form.dispatchErrorOccurredEventDialog(this, "Stop", 803, new Object[0]);
        return;
      }
      finally
      {
      ...
      this.form.dispatchErrorOccurredEvent(this, "recording", 804, new Object[0]);
      continue;
      this.form.dispatchErrorOccurredEvent(this, "recording", 805, new Object[0]);
    }
  }
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\com\google\appinventor\components\runtime\SoundRecorder.class
