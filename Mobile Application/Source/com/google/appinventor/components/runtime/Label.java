  ...
  extends AndroidViewComponent
{
  ...
  public void HTMLFormat(boolean paramBoolean)
  {
    ...
    if (this.htmlFormat)
    {
      str = TextViewUtil.getText(this.view);
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\com\google\appinventor\components\runtime\Label.class
