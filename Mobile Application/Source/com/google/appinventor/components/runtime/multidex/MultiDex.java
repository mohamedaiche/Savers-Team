...
public final class MultiDex
{
  ...
  {
    installedApk.clear();
    Log.i("MultiDex", "install: doIt = " + paramBoolean);
    ...
    try
    {
      ...
      {
        Log.d("MultiDex", "applicationInfo is null, returning");
        return true;
      }
    }
    ...
    try
    {
      ...
      if ((!paramBoolean) && (MultiDexExtractor.mustLoad(paramContext, localApplicationInfo)))
      {
        Log.d("MultiDex", "Returning because of mustLoad");
        return false;
      }
    }
    catch (Throwable localThrowable)
    {
      ...
      Log.d("MultiDex", "Proceeding with installation...");
      List localList = MultiDexExtractor.load(paramContext, localApplicationInfo, localThrowable, false);
      if (checkValidZipFiles(localList)) {
        installSecondaryDexes((ClassLoader)localObject, localThrowable, localList);
      }
      for (;;)
      {
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\com\google\appinventor\components\runtime\multidex\MultiDex.class
