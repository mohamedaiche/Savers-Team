  ...
  implements Component
{
  ...
  private void textInputDialog(final String paramString1, final String paramString2, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramString2 = this.activity.getString(17039360);
      localAlertDialog.setButton(-2, paramString2, new DialogInterface.OnClickListener()
      {
        public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
          Notifier.this.HideKeyboard(paramString1);
          Notifier.this.AfterTextInput(paramString2);
        }
      });
    }
  ...
  public static void twoButtonDialog(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean, Runnable paramRunnable1, Runnable paramRunnable2, Runnable paramRunnable3)
  {
    ...
    localAlertDialog.setButton(-3, paramString4, new DialogInterface.OnClickListener()
    {
      public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
      {
    ...
    if (paramBoolean) {
      localAlertDialog.setButton(-2, paramActivity.getString(17039360), new DialogInterface.OnClickListener()
      {
        public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
        {
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\com\google\appinventor\components\runtime\Notifier.class
