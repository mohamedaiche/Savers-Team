  ...
  extends MethodProc
{
  ...
  public void addAtEnd(MethodProc paramMethodProc)
  {
    ...
    //   35: iload_3
    //   36: aload_0
    //   37: getfield 60	gnu/expr/GenericProc:minArgs	I
    //   40: if_icmplt +10 -> 50
    //   43: aload_0
    //   44: getfield 40	gnu/expr/GenericProc:count	I
    //   47: ifne +8 -> 55
    //   50: aload_0
    //   51: iload_3
    //   52: putfield 60	gnu/expr/GenericProc:minArgs	I
    //   55: aload_1
    //   56: invokevirtual 62	gnu/mapping/MethodProc:maxArgs	()I
    //   59: istore_3
    //   60: iload_3
    //   61: iconst_m1
    //   62: if_icmpeq +11 -> 73
    //   65: iload_3
    //   66: aload_0
    //   67: getfield 64	gnu/expr/GenericProc:maxArgs	I
    //   70: if_icmple +8 -> 78
    //   73: aload_0
    //   74: iload_3
    //   75: putfield 64	gnu/expr/GenericProc:maxArgs	I
    //   78: aload_0
    //   79: iload_2
    //   80: iconst_1
    //   81: iadd
    //   82: putfield 40	gnu/expr/GenericProc:count	I
    //   85: aload_0
    //   86: monitorexit
    //   87: return
    //   88: iload_2
    //   89: aload_0
    //   90: getfield 42	gnu/expr/GenericProc:methods	[Lgnu/mapping/MethodProc;
    //   93: arraylength
    //   94: if_icmplt -71 -> 23
    //   97: aload_0
    //   98: getfield 42	gnu/expr/GenericProc:methods	[Lgnu/mapping/MethodProc;
    //   101: arraylength
    //   102: iconst_2
    //   103: imul
    //   104: anewarray 4	gnu/mapping/MethodProc
    //   107: astore 4
    //   109: aload_0
    //   110: getfield 42	gnu/expr/GenericProc:methods	[Lgnu/mapping/MethodProc;
    //   113: iconst_0
    //   114: aload 4
    //   116: iconst_0
    //   117: iload_2
    //   118: invokestatic 52	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   121: aload_0
    //   122: aload 4
    //   124: putfield 42	gnu/expr/GenericProc:methods	[Lgnu/mapping/MethodProc;
    //   127: goto -104 -> 23
    //   130: astore_1
    //   131: aload_0
    //   132: monitorexit
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	135	0	this	GenericProc
    //   0	135	1	paramMethodProc	MethodProc
    //   6	112	2	i	int
    //   34	41	3	j	int
    //   107	16	4	arrayOfMethodProc	MethodProc[]
    // Exception table:
    //   from	to	target	type
    //   2	23	130	finally
    //   23	50	130	finally
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\gnu\expr\GenericProc.class
