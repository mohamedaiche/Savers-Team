...
public class ModuleManager
{
  ...
  private void add(ModuleInfo paramModuleInfo)
  {
    ...
    //   27	10	2	i	int
    //   22	58	3	arrayOfModuleInfo	ModuleInfo[]
    // Exception table:
    //   from	to	target	type
    //   2	18	86	finally
    //   18	35	86	finally
  ...
  private ModuleInfo searchWithAbsSourcePath(String paramString)
  {
    ...
    //   23: aload_1
    //   24: aload 4
    //   26: invokevirtual 73	gnu/expr/ModuleInfo:getSourceAbsPathname	()Ljava/lang/String;
    //   29: invokevirtual 79	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   32: istore_3
    //   33: iload_3
    //   34: ifeq -27 -> 7
    //   37: aload 4
    ...
    //   6	14	2	i	int
    //   32	2	3	bool	boolean
    //   21	17	4	localModuleInfo	ModuleInfo
    // Exception table:
    //   from	to	target	type
    //   2	7	49	finally
    //   15	33	49	finally
  ...
  public ModuleInfo getModule(int paramInt)
  {
    ...
    //   0	33	1	paramInt	int
    //   6	4	2	i	int
    //   13	12	3	localModuleInfo	ModuleInfo
  ...
  public ModuleInfo searchWithClassName(String paramString)
  {
    ...
    //   23: aload_1
    //   24: aload 4
    //   26: invokevirtual 260	gnu/expr/ModuleInfo:getClassName	()Ljava/lang/String;
    //   29: invokevirtual 79	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   32: istore_3
    //   33: iload_3
    //   34: ifeq -27 -> 7
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\gnu\expr\ModuleManager.class
