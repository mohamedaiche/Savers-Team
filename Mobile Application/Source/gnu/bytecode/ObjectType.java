  ...
  extends Type
{
    ...
    throws ClassNotFoundException
  {
    try
    {
      Class localClass1 = Class.forName(paramString, false, ObjectType.class.getClassLoader());
      return localClass1;
    }
    catch (ClassNotFoundException localClassNotFoundException1)
    {
      try
      {
        Class localClass2 = Class.forName(paramString, false, getThreadContextClassLoader());
        return localClass2;
      }
...
/* Location:              C:\Users\Mohamed\Downloads\dex2jar-2.0\dex2jar-2.0\classes-dex2jar.jar!\gnu\bytecode\ObjectType.class
